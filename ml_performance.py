...
# training & validation
ROUNDS = 50
SAMPLE_SIZES = np.array([0.03, 0.05, 0.1, 0.25, 0.5, 1.0])
...
CV_SPLIT_SIZE = np.array([2, 5, 7, 9, 13])
MAIN_METRICS = np.array(['accuracy', 'balanced_accuracy', 'f1', 'precision', 'recall'])  # 'accuracy' ,'balanced_accuracy', 'f1', 'precision', 'recall'
...
PAR_SPLIT_SIZE = np.array([2, 5, 7, 9, 13])
