...
MODELS = np.array(['logistic_regression']) # 'svm', 'logistic_regression', 'naive_bayes', 'knn', 'random_forest', 'decision_tree'
...
def do_calc(subgroup, model, main_metric, sample_size, feature_selector, feature_selection_frac, validation_type, par_split_size, cv_split_size, train_size):
    ...
    entry = pd.DataFrame([[subgroup,
                         ...
                         columns=['subgroup','model', 'main_metric', 'sample_size', 'feature_selector',
